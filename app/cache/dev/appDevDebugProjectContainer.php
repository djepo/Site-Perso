...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:\\Program Files (x86)\\EasyPHP-5.3.8.1\\www\\PhpProject2\\app/cache/dev/annotations', true);
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('C:\\Program Files (x86)\\EasyPHP-5.3.8.1\\www\\PhpProject2\\app/cache/dev/assetic/config'), true)));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'siteperso', 'host' => 'localhost', 'port' => '3306', 'user' => 'root', 'password' => '', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $a, $b, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_fa8dc45a2f19d299dd22cab393506084');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_fa8dc45a2f19d299dd22cab393506084');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_fa8dc45a2f19d299dd22cab393506084');
        ...
        $i->setProxyDir('C:\\Program Files (x86)\\EasyPHP-5.3.8.1\\www\\PhpProject2\\app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:\\Program Files (x86)\\EasyPHP-5.3.8.1\\www\\PhpProject2\\app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\SqliteProfilerStorage('sqlite:C:\\Program Files (x86)\\EasyPHP-5.3.8.1\\www\\PhpProject2\\app/cache/dev/profiler.db', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:\\Program Files (x86)\\EasyPHP-5.3.8.1\\www\\PhpProject2\\app/config/routing_dev.yml', array('cache_dir' => 'C:\\Program Files (x86)\\EasyPHP-5.3.8.1\\www\\PhpProject2\\app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appdevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appdevUrlMatcher'));
    }
    ...
    {
        return $this->services['sensio.distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:\\Program Files (x86)\\EasyPHP-5.3.8.1\\www\\PhpProject2\\app');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => 'php', 'translation.loader.yml' => 'yml', 'translation.loader.xliff' => 'xliff'), array('cache_dir' => 'C:\\Program Files (x86)\\EasyPHP-5.3.8.1\\www\\PhpProject2\\app/cache/dev/translations', 'debug' => true), $this->get('session'));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => 'C:\\Program Files (x86)\\EasyPHP-5.3.8.1\\www\\PhpProject2\\app/cache/dev/twig', 'charset' => 'UTF-8'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, new \Symfony\Component\DependencyInjection\ParameterBag\ParameterBag($this->getDefaultParameters()), 'C:\\Program Files (x86)\\EasyPHP-5.3.8.1\\www\\PhpProject2\\app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:\\Program Files (x86)\\EasyPHP-5.3.8.1\\www\\PhpProject2\\app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:\\Program Files (x86)\\EasyPHP-5.3.8.1\\www\\PhpProject2\\app/cache/dev');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:\\Program Files (x86)\\EasyPHP-5.3.8.1\\www\\PhpProject2\\app/cache/dev',
            ...
            'debug.container.dump' => 'C:\\Program Files (x86)\\EasyPHP-5.3.8.1\\www\\PhpProject2\\app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'profiler.storage.dsn' => 'sqlite:C:\\Program Files (x86)\\EasyPHP-5.3.8.1\\www\\PhpProject2\\app/cache/dev/profiler.db',
            ...
            'router.resource' => 'C:\\Program Files (x86)\\EasyPHP-5.3.8.1\\www\\PhpProject2\\app/config/routing_dev.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:\\Program Files (x86)\\EasyPHP-5.3.8.1\\www\\PhpProject2\\app/cache/dev/twig',
                'charset' => 'UTF-8',
            ),
            ...
            'doctrine.orm.proxy_dir' => 'C:\\Program Files (x86)\\EasyPHP-5.3.8.1\\www\\PhpProject2\\app/cache/dev/doctrine/orm/Proxies',
            ...
            'assetic.cache_dir' => 'C:\\Program Files (x86)\\EasyPHP-5.3.8.1\\www\\PhpProject2\\app/cache/dev/assetic',
